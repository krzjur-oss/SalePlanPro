import{r as w,j as e}from"./vendor-react-NQNxyWao.js";import{f as jt,a as ue,c as yt}from"./index-BiexWSzO.js";import{n as L,a6 as wt,C as Re,d as Nt,X as kt}from"./vendor-lucide-BzWLwViq.js";import"./vendor-motion-FDUFV107.js";const G=["Poniedziałek","Wtorek","Środa","Czwartek","Piątek"];function z(m){return String(m??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Ge(m,K){const v=[];let C=null;return m.forEach((P,ae)=>{const T=P.floor.buildingIdx,U=K[T],E=(U==null?void 0:U.name)||"",Z=P.floor.id,M=P.floor.name,_=`${T}|${Z}`;!C||C.key!==_?(C={startIdx:ae,span:1,key:_,name:M,buildingName:E},v.push(C)):C.span++}),v}function Te(m){const K=[];let v=null;return m.forEach((C,P)=>{var M,_;const ae=C.floor.buildingIdx,T=C.floor.id,U=((M=C.seg)==null?void 0:M.id)||"default_seg",E=((_=C.seg)==null?void 0:_.name)||"Główny",Z=`${ae}|${T}|${U}`;!v||v.key!==Z?(v={startIdx:P,span:1,key:Z,name:E},K.push(v)):v.span++}),K}function St({appState:m,schedData:K}){var tt;const[v,C]=w.useState("classes"),[P,ae]=w.useState("etap1"),[T,U]=w.useState("all"),[E,Z]=w.useState("all"),[M,_]=w.useState("all"),[st,he]=w.useState(!1),[at,Oe]=w.useState(!1),[$e,We]=w.useState(!1),[re,Ke]=w.useState("landscape"),[fe,Ie]=w.useState(!1),[X,Ue]=w.useState("landscape"),[ge,rt]=w.useState("floors"),[je,nt]=w.useState("all"),[ne,ot]=w.useState(12),[oe,lt]=w.useState("all"),[le,it]=w.useState("all"),[vt,zt]=w.useState(1),[dt,ye]=w.useState(!1),[Pe,ct]=w.useState(1),[Ae,pt]=w.useState("all");w.useEffect(()=>{try{Oe(window.self!==window.top)}catch{Oe(!0)}},[]),w.useEffect(()=>{if($e||fe){let t=document.querySelector('meta[name="viewport"]');const i=t?t.getAttribute("content"):"";t||(t=document.createElement("meta"),t.setAttribute("name","viewport"),document.head.appendChild(t));const s=fe?X:re,o=s==="landscape"?"1120":"794";t.setAttribute("content",`width=${o}, initial-scale=0.8, shrink-to-fit=no`);const n=document.createElement("style");return n.id="print-mobile-viewport-adjustments",n.innerHTML=`
        @media print {
          @page {
            size: ${s};
            margin: 6mm 8mm;
      ...
      `,document.head.appendChild(n),()=>{t&&(i?t.setAttribute("content",i):t.removeAttribute("content"));const r=document.getElementById("print-mobile-viewport-adjustments");r&&r.remove()}}},[$e,re,fe,X]);const b=m.planLekcji,ie=w.useMemo(()=>{const t=m.yearLabel||"",i=t.match(/(\d{4})/);let s=new Date().getFullYear(),o=s+1;if(i){s=parseInt(i[1],10);const n=t.match(/\d{4}.*?(\d{4})/);n?o=parseInt(n[1],10):o=s+1}return{start:`${s}-09-01`,end:`${o}-06-25`}},[m.yearLabel]),[Se,Fe]=w.useState(ie.start),[Ce,Ye]=w.useState(ie.end),[De,xt]=w.useState("[Przedmiot] - [Klasa] [Sala]");w.useEffect(()=>{Fe(ie.start),Ye(ie.end)},[ie]);const Be=(t,i)=>{const s=new Date(t),o=i+1,n=s.getDay();let r=o-n;r<0&&(r+=7);const l=new Date(s);return l.setDate(s.getDate()+r),l},ee=t=>{const i=t.getFullYear(),s=String(t.getMonth()+1).padStart(2,"0"),o=String(t.getDate()).padStart(2,"0"),n=String(t.getHours()).padStart(2,"0"),r=String(t.getMinutes()).padStart(2,"0"),l=String(t.getSeconds()).padStart(2,"0");return`${i}${s}${o}T${n}${r}${l}`},He=t=>{const i=t.getFullYear(),s=String(t.getMonth()+1).padStart(2,"0"),o=String(t.getDate()).padStart(2,"0");return`${i}${s}${o}T235959Z`},te=t=>t?t.replace(/\\/g,"\\\\").replace(/,/g,"\\,").replace(/;/g,"\\;").replace(/\n/g,"\\n").trim():"",Ze=["MO","TU","WE","TH","FR"],_e=t=>{const i=[];for(let s=0;s<5;s++)F.forEach((o,n)=>{const r=String(o.num);let l=[];P==="etap1"?Object.entries(b.lessons).forEach(([a,d])=>{var h,g;const c=a.split("|"),p=c[0],u=parseInt(c[1],10),x=parseInt(c[2],10);if(u===s&&x===n){const f=b.assignments.find(j=>j.id===d.assignmentId);if(f&&f.teacherId===t.id){const j=((h=V.get(f.subjectId))==null?void 0:h.name)||"Inny",N=((g=de.get(p))==null?void 0:g.name)||"Inna",k=f.roomId?ce.get(f.roomId):null;l.push({subject:j,className:N,roomName:k==null?void 0:k.name})}}}):(((se.teachers[t.id]||{})[s]||{})[r]||[]).forEach(p=>{var u;l.push({subject:p.subject,className:p.className||((u=p.classes)==null?void 0:u.join("+"))||"Klasa",roomName:p.note})}),l.forEach(a=>{i.push({dayIdx:s,hourNum:o.num,start:o.start,end:o.end,subject:a.subject,className:a.className,roomName:a.roomName})})});return i},Ve=t=>{const i=_e(t);if(i.length===0){alert(`Nauczyciel ${t.last} ${t.first} nie ma przypisanych żadnych lekcji w wybranym planie.`);return}let s=["BEGIN:VCALENDAR","VERSION:2.0","PRODID:-//SalePlan Pro//NONSGML v1.0//PL","CALSCALE:GREGORIAN","METHOD:PUBLISH"];i.forEach(a=>{const d=Be(Se,a.dayIdx),[c,p]=a.start.split(":").map(Number),[u,x]=a.end.split(":").map(Number),h=new Date(d);h.setHours(c,p,0,0);const g=new Date(d);g.setHours(u,x,0,0);const f=De.replace("[Przedmiot]",a.subject).replace("[Klasa]",a.className).replace("[Sala]",a.roomName?`s. ${a.roomName}`:"").replace(/\s+/g," ").trim(),j=`Lekcja: ${a.hourNum} (${a.start}-${a.end})\\nNauczyciel: ${t.last} ${t.first} (${t.abbr})\\nKlasa: ${a.className}\\n`+(a.roomName?`Sala: ${a.roomName}\\n`:"")+"Wygenerowano automatycznie z SalePlan Pro",N=a.roomName?`Sala ${a.roomName}`:"",k=`asg-${t.id}-${a.dayIdx}-${a.hourNum}-${a.className.replace(/[^a-zA-Z0-9]/g,"")}-${Date.now()}@saleplan.pro`,$=new Date(Ce);s.push("BEGIN:VEVENT"),s.push(`UID:${k}`),s.push(`DTSTAMP:${ee(new Date)}Z`),s.push(`DTSTART:${ee(h)}`),s.push(`DTEND:${ee(g)}`),s.push(`RRULE:FREQ=WEEKLY;UNTIL=${He($)};BYDAY=${Ze[a.dayIdx]}`),s.push(`SUMMARY:${te(f)}`),s.push(`LOCATION:${te(N)}`),s.push(`DESCRIPTION:${te(j)}`),s.push("END:VEVENT")}),s.push("END:VCALENDAR");const o=s.join(`\r
`),n=new Blob([o],{type:"text/calendar;charset=utf-8"}),r=URL.createObjectURL(n),l=document.createElement("a");l.href=r,l.download=`plan_${t.last}_${t.first}.ics`,document.body.appendChild(l),l.click(),document.body.removeChild(l),URL.revokeObjectURL(r)},mt=()=>{let t=["BEGIN:VCALENDAR","VERSION:2.0","PRODID:-//SalePlan Pro//NONSGML v1.0//PL","CALSCALE:GREGORIAN","METHOD:PUBLISH"],i=0;if(b.teachers.forEach(l=>{_e(l).forEach(d=>{i++;const c=Be(Se,d.dayIdx),[p,u]=d.start.split(":").map(Number),[x,h]=d.end.split(":").map(Number),g=new Date(c);g.setHours(p,u,0,0);const f=new Date(c);f.setHours(x,h,0,0);const j=`[${l.abbr}] `+De.replace("[Przedmiot]",d.subject).replace("[Klasa]",d.className).replace("[Sala]",d.roomName?`s. ${d.roomName}`:"").replace(/\s+/g," ").trim(),N=`Nauczyciel: ${l.last} ${l.first} (${l.abbr})\\nLekcja: ${d.hourNum} (${d.start}-${d.end})\\nKlasa: ${d.className}\\n`+(d.roomName?`Sala: ${d.roomName}\\n`:"")+"Wygenerowano automatycznie z SalePlan Pro",k=d.roomName?`Sala ${d.roomName}`:"",$=`asg-all-${l.id}-${d.dayIdx}-${d.hourNum}-${d.className.replace(/[^a-zA-Z0-9]/g,"")}-${Date.now()}-${i}@saleplan.pro`,y=new Date(Ce);t.push("BEGIN:VEVENT"),t.push(`UID:${$}`),t.push(`DTSTAMP:${ee(new Date)}Z`),t.push(`DTSTART:${ee(g)}`),t.push(`DTEND:${ee(f)}`),t.push(`RRULE:FREQ=WEEKLY;UNTIL=${He(y)};BYDAY=${Ze[d.dayIdx]}`),t.push(`SUMMARY:${te(j)}`),t.push(`LOCATION:${te(k)}`),t.push(`DESCRIPTION:${te(N)}`),t.push("END:VEVENT")})}),i===0){alert("Brak przypisanych lekcji w całym planie lekcji.");return}t.push("END:VCALENDAR");const s=t.join(`\r
`),o=new Blob([s],{type:"text/calendar;charset=utf-8"}),n=URL.createObjectURL(o),r=document.createElement("a");r.href=n,r.download="plan_wszyscy_nauczyciele.ics",document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(n)},de=w.useMemo(()=>new Map(b.classes.map(t=>[t.id,t])),[b.classes]),Le=w.useMemo(()=>new Map(b.teachers.map(t=>[t.id,t])),[b.teachers]),V=w.useMemo(()=>new Map(b.subjects.map(t=>[t.id,t])),[b.subjects]),ce=w.useMemo(()=>new Map(b.rooms.map(t=>[t.id,t])),[b.rooms]),qe=w.useMemo(()=>new Map((b.schoolGroups||[]).map(t=>[t.id,t])),[b.schoolGroups]),Je=(t,i)=>{if(i&&i.short&&String(i.short).trim())return String(i.short).trim();const s=b.subjects.find(l=>l.id===t||l.name.toLowerCase().trim()===String(t).toLowerCase().trim());if(s&&s.short&&s.short.trim())return s.short.trim();const o=m.subjects.find(l=>l.id===t||l.name.toLowerCase().trim()===String(t).toLowerCase().trim());if(o&&o.short&&o.short.trim())return o.short.trim();const n=(s==null?void 0:s.name)||(o==null?void 0:o.name)||t||"";if(!n)return"";if(n.length<=4)return n;const r=n.toLowerCase();return r.includes("angielsk")?"ang":r.includes("polsk")?"pol":r.includes("matemat")?"mat":r.includes("fizyk")?"fiz":r.includes("chem")?"chem":r.includes("biolog")?"biol":r.includes("geograf")?"geogr":r.includes("histor")?"hist":r.includes("informat")?"inf":r.includes("fizyczn")||r.includes("w-f")||r.includes("wf")?"WF":r.includes("relig")?"rel":r.includes("muzyk")?"muz":r.includes("plastyk")?"plas":r.includes("technik")?"tech":r.includes("niemieck")?"niem":r.includes("hiszpań")||r.includes("hiszpan")?"hiszp":r.includes("francusk")?"franc":r.includes("rosyjsk")?"ros":r.includes("etyk")?"etyka":r.includes("godzina wychowawcza")||r.includes("zajęcia z wychowawcą")?"GW":r.includes("edukacja wczesnoszkolna")?"EW":r.includes("edukacja dla bezpieczeństwa")?"EDB":r.includes("wiedza o społeczeństwie")?"WOS":r.includes("historia i teraźniejszość")?"HIT":n.slice(0,4)},Qe=(t,i)=>{if(!t)return"";const s=String(t).trim();if(!s)return"";const o=(b.schoolGroups||[]).find(d=>d.id===s||d.name.toLowerCase()===s.toLowerCase()),n=o?o.name.trim():s;if(/^g\s*\d+$/i.test(n))return n.toUpperCase().replace(/\s+/,"");const r=n.match(/^grupa\s*(\d+|[a-zA-Z]+)/i);if(r)return`G${r[1].toUpperCase()}`;const l=n.match(/^gr\.?\s*(\d+|[a-zA-Z]+)/i);if(l)return`G${l[1].toUpperCase()}`;if(/^\d+$/.test(n))return`G${n}`;if(/^1\/2$/i.test(n)||/^gr\.?\s*1\/2$/i.test(n))return"G1";if(/^2\/2$/i.test(n)||/^gr\.?\s*2\/2$/i.test(n))return"G2";if(n.toLowerCase()==="chłopcy"||n.toLowerCase()==="chlopcy")return"chł";if(n.toLowerCase()==="dziewczęta"||n.toLowerCase()==="dziewczeta")return"dz";const a=n.toLowerCase();if(a.includes("relig")||a.includes("mniejszoś")||a.includes("mniejszos")||a.includes("hiszpań")||a.includes("hiszpan")||a.includes("niemieck")||a.includes("angielsk")||a.includes("informat")||a.includes("etyk")||a.includes("fizyczn")||a.includes("wf"))return"";if(i){const d=i.toLowerCase();if(a.includes(d)||d.includes(a))return""}return n.length<=4&&!/^[A-Z0-9]{3,}$/.test(n)?n:""},F=w.useMemo(()=>b.hours&&b.hours.length>0?b.hours:[{num:1,start:"08:00",end:"08:45"},{num:2,start:"08:55",end:"09:40"},{num:3,start:"09:50",end:"10:35"},{num:4,start:"10:55",end:"11:40"},{num:5,start:"11:50",end:"12:35"}],[b.hours]),se=w.useMemo(()=>{const t=m.yearKey,i=K[t]||{},s={},o={},n={};return Object.entries(i).forEach(([r,l])=>{const a=parseInt(r,10);Object.entries(l).forEach(([d,c])=>{Object.entries(c).forEach(([p,u])=>{(Array.isArray(u)?u:[u]).forEach(h=>{var N,k,$;if(!h)return;const g=p.split("_"),f=g[g.length-1]||"";if(h.classes&&h.classes.length>0)h.classes.forEach(y=>{var R;const A=((R=b.classes.find(I=>I.name===y))==null?void 0:R.id)||y;s[A]||(s[A]={}),s[A][a]||(s[A][a]={}),s[A][a][d]||(s[A][a][d]=[]),s[A][a][d].push({...h,note:f})});else if(h.className){const y=((N=b.classes.find(A=>A.name===h.className))==null?void 0:N.id)||h.className;s[y]||(s[y]={}),s[y][a]||(s[y][a]={}),s[y][a][d]||(s[y][a][d]=[]),s[y][a][d].push({...h,note:f})}const j=h.teacherAbbr;if(j){const y=((k=b.teachers.find(A=>A.abbr===j))==null?void 0:k.id)||j;o[y]||(o[y]={}),o[y][a]||(o[y][a]={}),o[y][a][d]||(o[y][a][d]=[]),o[y][a][d].push({...h,note:f})}if(f){const y=(($=b.rooms.find(A=>A.name===f))==null?void 0:$.id)||f;n[y]||(n[y]={}),n[y][a]||(n[y][a]={}),n[y][a][d]||(n[y][a][d]=[]),n[y][a][d].push({...h,note:f})}})})})}),{classes:s,teachers:o,rooms:n}},[K,m.yearKey,b.classes,b.teachers,b.rooms]),bt=()=>{window.print()},Xe=(t,i)=>{if(!i||i<=0||t.length<=i)return[t];const s=[];for(let o=0;o<t.length;o+=i)s.push(t.slice(o,o+i));return s},Ee=(t,i,s,o)=>{var l,a,d;const n=[];if(P==="etap1"){const c=new Set;Object.entries(b.lessons).forEach(([p,u])=>{var N,k;const x=p.split("|"),h=x[0],g=parseInt(x[1],10),f=parseInt(x[2],10),j=x[3]||null;if(g===i&&f===o){const $=b.assignments.find(y=>y.id===u.assignmentId);if($){const y=b.rooms.find(R=>R.id===$.roomId);if($.roomId===t.room.id||y&&y.name.toLowerCase().trim()===t.room.num.toLowerCase().trim()){const R=`${$.id}-${h}-${$.groupId||j||""}`;if(c.has(R))return;c.add(R);const I=V.get($.subjectId)||b.subjects.find(H=>H.id===$.subjectId),W=(I==null?void 0:I.name)||"Przedmiot",J=(I==null?void 0:I.short)||Je($.subjectId,I);let Y=((N=de.get(h))==null?void 0:N.name)||"Klasa";if($.linkedClassIds&&$.linkedClassIds.length>0){const H=$.linkedClassIds.map(ze=>{var be;return(be=de.get(ze))==null?void 0:be.name}).filter(Boolean);Y=[Y,...H].join("+")}const B=Y.replace(/\s*\([^)]*\)/g,"").trim()||Y,O=$.groupId||j,D=O?b.schoolGroups.find(H=>H.id===O)||qe.get(O):null,xe=D?D.name:O||void 0,me=Qe(xe,J||W),S=$.teacherId&&((k=Le.get($.teacherId))==null?void 0:k.abbr)||"",ve=[B,J,me,S].filter(Boolean).join(" ");n.push({subject:W,subjectShort:J,className:B,groupName:xe,groupShort:me,teacherAbbr:S,displayText:ve})}}}})}else{const c=yt(t),p=(d=(a=(l=K[m.yearKey])==null?void 0:l[i])==null?void 0:a[s])==null?void 0:d[c];(Array.isArray(p)?p:p?[p]:[]).forEach(x=>{var B,O,D,xe,me;if(!x)return;const h=x.className||((B=x.classes)==null?void 0:B.join("+"))||"Klasa";let g=h,f="";const j=h.match(/\(([^)]+)\)/);j&&(f=j[1].trim(),g=h.replace(/\s*\([^)]*\)/g,"").trim()||h);const N=((O=x._bridgeMeta)!=null&&O.subjectId?V.get(x._bridgeMeta.subjectId)||b.subjects.find(S=>{var Q;return S.id===((Q=x._bridgeMeta)==null?void 0:Q.subjectId)}):null)||b.subjects.find(S=>S.name.toLowerCase().trim()===(x.subject||"").toLowerCase().trim()),k=x.subject||(N==null?void 0:N.name)||"Przedmiot",$=(N==null?void 0:N.short)||Je(x.subject,N);let y=(D=x._bridgeMeta)==null?void 0:D.groupId;if(!y&&((xe=x._bridgeMeta)!=null&&xe.classId)&&((me=x._bridgeMeta)!=null&&me.subjectId)){const S=b.assignments.find(Q=>{var ve,H,ze,be;return Q.classId===((ve=x._bridgeMeta)==null?void 0:ve.classId)&&Q.subjectId===((H=x._bridgeMeta)==null?void 0:H.subjectId)&&(!((ze=x._bridgeMeta)!=null&&ze.teacherId)||Q.teacherId===((be=x._bridgeMeta)==null?void 0:be.teacherId))});S!=null&&S.groupId&&(y=S.groupId)}if(!y&&f&&(y=f),!y&&x.note){const S=x.note.match(/\b(G\d+|gr\.?\s*\d+|grupa\s*\d+|1\/2|2\/2|chłopcy|dziewczęta)\b/i);S&&(y=S[0])}const A=y?b.schoolGroups.find(S=>S.id===y)||qe.get(y):null,R=A?A.name:y||void 0,I=Qe(R,$||k),W=x.teacherAbbr||"",Y=[g,$,I,W].filter(Boolean).join(" ");n.push({subject:k,subjectShort:$,className:g,groupName:R,groupShort:I,teacherAbbr:W,displayText:Y})})}const r=new Set;return n.filter(c=>{const p=`${c.className}|${c.subjectShort}|${c.groupShort}|${c.teacherAbbr}`;return r.has(p)?!1:(r.add(p),!0)})},ut=()=>{const t=pe,i=oe==="all"?[0,1,2,3,4]:[oe],s=le==="all"?t:t.filter(n=>n.id===le);let o="";return i.forEach(n=>{s.forEach(r=>{const l=Xe(r.cols,ne>0?ne:r.cols.length);l.forEach((a,d)=>{const c=a.length,p=Ge(a,m.buildings),u=Te(a);let x="4px 3px",h="3px 2px",g="10px",f="8.5px",j="9px",N="8.5px",k="10.5px",$="7.5px",y=!0;c>14?(x="2px 1px",h="2px 1px",g="8.5px",f="7.5px",j="8px",N="7.5px",k="8px",$="6.5px",y=!1):c>10&&(x="3px 2px",h="2.5px 1.5px",g="9px",f="8px",j="8.5px",N="8px",k="9.5px",$="7px");let A="";F.forEach((I,W)=>{let J="";a.forEach(Y=>{const B=Ee(Y,n,I.num,W);let O='<span style="color: #cbd5e1; font-weight: bold; font-family: monospace;">-</span>';B.length>0&&(O=B.map(D=>`
                  <div style="line-height: 1.15; font-family: system-ui, -apple-system, sans-serif; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; margin: 1px 0;" title="${z(D.displayText)} (${z(D.subject)})">
                    <div style="color: #0f172a; font-weight: 900; font-size: ${g}; letter-spacing: -0.01em;">
                      ${z(D.className)}
                    </div>
                    ${D.groupShort?`
                    ...
                    <div style="color: #1e293b; font-weight: 800; font-size: ${j}; max-width: 100%; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                      ${z(D.subjectShort||D.subject)}
                    </div>
                    ${D.teacherAbbr?`
                      <div style="color: #334155; font-weight: 700; font-family: monospace; font-size: ${N};">
                        ${z(D.teacherAbbr)}
                      </div>`:""}
                  </div>
                `).join('<div style="border-top: 1px dashed #cbd5e1; margin: 2px 0; width: 80%;"></div>')),J+=`
            ...
            `});const R=l.length>1?` — CZĘŚĆ ${d+1}/${l.length} (Sal: ${c})`:` (Sal: ${c})`;o+=`
              ...
              <div style="display: flex; justify-content: space-between; align-items: flex-end; border-bottom: 2px solid #0f172a; padding-bottom: 4px; margin-bottom: 6px;">
                <div>
                  <div style="font-size: 12.5px; font-weight: 950; color: #0f172a; letter-spacing: -0.01em;">
                    📅 ${z(G[n].toUpperCase())} — ${z(r.name.toUpperCase())}${z(R)}
                  </div>
              ...
              <table style="width: 100%; border-collapse: collapse; font-family: system-ui, -apple-system, sans-serif; table-layout: fixed; box-sizing: border-box;">
                <thead>
                  ...
                  <tr style="background-color: #f8fafc; -webkit-print-color-adjust: exact; print-color-adjust: exact;">
                    ...
                    ${a.map(I=>{const W=I.room.sub||"sala ogólna";return`
                        <th style="border: 1px solid #94a3b8; padding: ${x}; text-align: center; font-size: 9.5px; font-weight: 950; color: #020617; width: calc((100% - 54px) / ${c}); box-sizing: border-box;">
                          ...
                          ${y?`<span style="font-size: ${$}; color: #475569; font-weight: 500; display: block; margin-top: 0.5px; text-transform: lowercase; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">(${z(W)})</span>`:""}
                        </th>
                      `}).join("")}
                  </tr>
                </thead>
    ...
    `},ft=()=>{try{const t=ht(),i=window.open("","_blank","noopener");i?(i.document.write(t),i.document.close()):he(!0)}catch(t){console.error(t),he(!0)}},Ne=w.useMemo(()=>T==="all"?b.classes:b.classes.filter(t=>t.id===T),[b.classes,T]),ke=w.useMemo(()=>E==="all"?b.teachers:b.teachers.filter(t=>t.id===E),[b.teachers,E]),Me=w.useMemo(()=>M==="all"?b.rooms:b.rooms.filter(t=>t.id===M),[b.rooms,M]),q=w.useMemo(()=>{const t=jt(m.floors),i=M==="all"?t:t.filter(a=>{const d=(a.room.num||"").toLowerCase().trim(),c=b.rooms.find(p=>p.name.toLowerCase().trim()===d);return c&&c.id===M}),s=[],o=[],n=[],r=new Map(b.rooms.map(a=>[a.name.toLowerCase().trim(),a]));i.forEach(a=>{const d=(a.room.num||"").toLowerCase().trim(),c=r.get(d),p=m.buildings[a.floor.buildingIdx],u=(c==null?void 0:c.type)==="indywidualne",x=(c==null?void 0:c.type)==="sport"||(p==null?void 0:p.multi)===!0;u?o.push(a):x?n.push(a):s.push(a)});const l=(a,d)=>{const c=a.room.num||"",p=d.room.num||"";return c.localeCompare(p,void 0,{numeric:!0,sensitivity:"base"})};return s.sort(l),o.sort(l),n.sort(l),{main:s,individual:o,sport:n}},[m.floors,m.buildings,b.rooms,M]),gt=w.useMemo(()=>{const t=[],i=new Set;return m.floors.forEach((s,o)=>{const n=m.buildings[s.buildingIdx],r=(n==null?void 0:n.name)||`Budynek ${s.buildingIdx+1}`,l=ue(s.name||`Piętro ${o+1}`,r),a=`f_${o}`;i.has(a)||(i.add(a),t.push({id:a,name:`${r} - ${l}`,buildingName:r}))}),t},[m.floors,m.buildings]),pe=w.useMemo(()=>{if(ge==="floors"){const t=[...q.main,...q.individual,...q.sport],i=je==="all"?t:t.filter(o=>`f_${o.floorIdx}`===je),s=new Map;return i.forEach(o=>{const n=`f_${o.floorIdx}`,r=m.buildings[o.floor.buildingIdx],l=(r==null?void 0:r.name)||`Budynek ${o.floor.buildingIdx+1}`,a=ue(o.floor.name||`Piętro ${o.floorIdx+1}`,l),d=`${l} — ${a}`;s.has(n)||s.set(n,{id:n,name:d,icon:"📍",floorIdx:o.floorIdx,cols:[]}),s.get(n).cols.push(o)}),Array.from(s.values()).sort((o,n)=>o.floorIdx-n.floorIdx).filter(o=>o.cols.length>0)}return[{id:"main",name:"Budynek Główny",icon:"🏢",cols:q.main},{id:"individual",name:"Nauczanie Indywidualne",icon:"🗣️",cols:q.individual},{id:"sport",name:"Sale Sportowe",icon:"🏆",cols:q.sport}].filter(t=>t.cols.length>0)},[ge,je,q,m.floors,m.buildings]);if(fe){const t=oe==="all"?[0,1,2,3,4]:[oe],i=le==="all"?pe:pe.filter(s=>s.id===le);return e.jsxs("div",{id:"rooms-print-overlay",className:"fixed inset-0 bg-slate-100/90 backdrop-blur-md z-[9999] overflow-y-auto p-4 md:p-8 font-sans text-slate-800",children:[e.jsx("style",{dangerouslySetInnerHTML:{__html:`
          @media print {
        ...
        `}}),e.jsxs("div",{className:"no-print bg-slate-900 border border-slate-800 text-white rounded-2xl p-4 mb-6 max-w-7xl mx-auto shadow-xl flex flex-col lg:flex-row lg:items-center justify-between gap-4",children:[e.jsxs("div",{className:"flex items-center gap-2.5",children:[e.jsx("span",{className:"p-2 bg-slate-800 rounded-lg text-amber-400",children:e.jsx(L,{size:20})}),e.jsxs("div",{className:"text-left",children:[e.jsx("span",{className:"text-[10px] text-slate-400 block uppercase font-bold tracking-tight",children:"Studio Wydruku Płachty Sal"}),e.jsxs("h3",{className:"text-sm font-black uppercase text-white leading-tight",children:["Płachta Obłożenia Gabinetów • Układ A4 ",X==="landscape"?"Poziomy":"Pionowy"]})]})]}),e.jsxs("div",{className:"flex items-center gap-2.5 flex-wrap",children:[e.jsxs("div",{className:"flex items-center bg-slate-800 p-1 rounded-xl border border-slate-700",children:[e.jsx("button",{onClick:()=>Ue("landscape"),className:`px-3 py-1.5 rounded-lg text-[11px] font-black transition cursor-pointer ${X==="landscape"?"bg-amber-500 text-slate-950 shadow-sm":"text-slate-400 hover:text-white"}`,children:"Poziomo (A4)"}),e.jsx("button",{onClick:()=>Ue("portrait"),className:`px-3 py-1.5 rounded-lg text-[11px] font-black transition cursor-pointer ${X==="portrait"?"bg-amber-500 text-slate-950 shadow-sm":"text-slate-400 hover:text-white"}`,children:"Pionowo (A4)"})]}),e.jsxs("div",{className:"flex items-center gap-1.5 bg-slate-800 px-3 py-1.5 rounded-xl border border-slate-700",children:[e.jsx("span",{className:"text-[10px] font-bold text-slate-400 uppercase",children:"Układ tabel:"}),e.jsxs("select",{value:ge,onChange:s=>rt(s.target.value),className:"bg-transparent text-white text-[11px] font-black outline-none cursor-pointer",children:[e.jsx("option",{value:"floors",className:"bg-slate-800 text-white",children:"Podział wg Kondygnacji (Zalecany)"}),e.jsx("option",{value:"cols",className:"bg-slate-800 text-white",children:"Wg Kategorii / Budynków"})]})]}),ge==="floors"&&e.jsxs("div",{className:"flex items-center gap-1.5 bg-slate-800 px-3 py-1.5 rounded-xl border border-slate-700",children:[e.jsx("span",{className:"text-[10px] font-bold text-slate-400 uppercase",children:"Piętro:"}),e.jsxs("select",{value:je,onChange:s=>nt(s.target.value),className:"bg-transparent text-white text-[11px] font-black outline-none cursor-pointer",children:[e.jsx("option",{value:"all",className:"bg-slate-800 text-white",children:"Wszystkie kondygnacje"}),gt.map(s=>e.jsx("option",{value:s.id,className:"bg-slate-800 text-white",children:s.name},s.id))]})]}),e.jsxs("div",{className:"flex items-center gap-1.5 bg-slate-800 px-3 py-1.5 rounded-xl border border-slate-700",children:[e.jsx("span",{className:"text-[10px] font-bold text-slate-400 uppercase",children:"Sal / strona:"}),e.jsxs("select",{value:ne,onChange:s=>ot(parseInt(s.target.value,10)),className:"bg-transparent text-white text-[11px] font-black outline-none cursor-pointer",children:[e.jsx("option",{value:8,className:"bg-slate-800 text-white",children:"8 sal (Duża czytelność)"}),e.jsx("option",{value:10,className:"bg-slate-800 text-white",children:"10 sal (Zalecane A4)"}),e.jsx("option",{value:12,className:"bg-slate-800 text-white",children:"12 sal (Standard)"}),e.jsx("option",{value:15,className:"bg-slate-800 text-white",children:"15 sal (Kompakt)"}),e.jsx("option",{value:0,className:"bg-slate-800 text-white",children:"Wszystkie w 1 tabeli"})]})]}),e.jsxs("div",{className:"flex items-center gap-1.5 bg-slate-800 px-3 py-1.5 rounded-xl border border-slate-700",children:[e.jsx("span",{className:"text-[10px] font-bold text-slate-400 uppercase",children:"Dzień:"}),e.jsxs("select",{value:oe,onChange:s=>lt(s.target.value==="all"?"all":parseInt(s.target.value,10)),className:"bg-transparent text-white text-[11px] font-black outline-none cursor-pointer",children:[e.jsx("option",{value:"all",className:"bg-slate-800 text-white",children:"Wszystkie dni (Pn-Pt)"}),G.map((s,o)=>e.jsx("option",{value:o,className:"bg-slate-800 text-white",children:s},o))]})]}),e.jsxs("div",{className:"flex items-center gap-1.5 bg-slate-800 px-3 py-1.5 rounded-xl border border-slate-700",children:[e.jsx("span",{className:"text-[10px] font-bold text-slate-400 uppercase",children:"Budynek:"}),e.jsxs("select",{value:le,onChange:s=>it(s.target.value),className:"bg-transparent text-white text-[11px] font-black outline-none cursor-pointer",children:[e.jsx("option",{value:"all",className:"bg-slate-800 text-white",children:"Wszystkie kategorie"}),pe.map(s=>e.jsx("option",{value:s.id,className:"bg-slate-800 text-white",children:s.name},s.id))]})]}),e.jsxs("button",{onClick:we,className:"px-3.5 py-2 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-200 text-xs font-bold rounded-xl transition flex items-center gap-1.5 cursor-pointer",title:"Otwórz czysty HTML w nowej karcie",children:[e.jsx(wt,{size:14})," W osobnym oknie"]}),e.jsxs("button",{onClick:()=>window.print(),className:"px-4 py-2 bg-amber-500 hover:bg-amber-600 text-slate-950 text-xs font-black rounded-xl shadow-lg transition flex items-center gap-1.5 cursor-pointer",children:[e.jsx(L,{size:15})," Drukuj teraz (Ctrl+P)"]}),e.jsx("button",{onClick:()=>Ie(!1),className:"px-3.5 py-2 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-300 text-xs font-bold rounded-xl transition cursor-pointer",children:"Zamknij"})]})]}),e.jsx("div",{className:"max-w-7xl mx-auto space-y-8",children:t.map(s=>e.jsx("div",{className:"space-y-6",children:i.map(o=>{const n=Xe(o.cols,ne>0?ne:o.cols.length);return n.map((r,l)=>{const a=r.length,d=Ge(r,m.buildings),c=Te(r),p=n.length>1?` — Część ${l+1}/${n.length} (Sal: ${a})`:` (Sal: ${a})`;return e.jsxs("div",{className:"rooms-sheet-card bg-white p-5 md:p-6 rounded-2xl border border-slate-200 shadow-md transition",children:[e.jsxs("div",{className:"flex justify-between items-end border-b-2 border-slate-900 pb-2 mb-3",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-base md:text-lg font-black text-slate-950 tracking-tight flex items-center gap-2",children:e.jsxs("span",{children:["📅 ",G[s].toUpperCase()," — ",o.name.toUpperCase(),p]})}),e.jsxs("p",{className:"text-[10.5px] text-slate-600 font-bold uppercase mt-0.5",children:[m.school.name," • Rok szkolny ",m.yearLabel," • ",P==="etap1"?"Plan Bazowy Klas (Etap 1)":"Plan Przydziału Sal (Etap 2)"]})]}),e.jsxs("div",{className:"text-right text-[9px] font-mono text-slate-400 font-bold uppercase leading-tight",children:["SalePlan Pro • Sal w szkole: ",Me.length,e.jsx("br",{}),"Wydrukowano: ",new Date().toLocaleDateString("pl-PL")]})]}),e.jsx("div",{className:"w-full overflow-hidden",children:e.jsxs("table",{className:"w-full text-xs text-left border-collapse table-fixed bg-white",children:[e.jsxs("thead",{children:[e.jsxs("tr",{className:"bg-slate-100 uppercase font-black text-slate-800",children:[e.jsx("th",{className:"w-[52px] min-w-[52px] max-w-[52px] border border-slate-300 p-1.5 text-center text-[10px]",children:"Godz"}),d.map((u,x)=>e.jsxs("th",{colSpan:u.span,className:"border border-slate-300 p-1.5 text-center text-[9.5px] bg-slate-50 font-bold text-slate-700",children:["📍 ",ue(u.name,u.buildingName)]},x))]}),e.jsxs("tr",{className:"bg-white uppercase font-black text-slate-500",children:[e.jsx("th",{className:"w-[52px] min-w-[52px] max-w-[52px] border border-slate-300 p-1 text-center text-[8px] bg-slate-50 font-medium text-slate-400",children:"-"}),c.map((u,x)=>e.jsxs("th",{colSpan:u.span,className:"border border-slate-300 p-1 text-center text-[8.5px] bg-white text-slate-500 uppercase font-semibold",children:["🧩 ",u.name]},x))]}),e.jsxs("tr",{className:"bg-slate-50 uppercase font-black text-slate-800",children:[e.jsx("th",{className:"w-[52px] min-w-[52px] max-w-[52px] border border-slate-300 p-1.5 text-center text-[10px]",children:"Nr"}),r.map((u,x)=>e.jsxs("th",{style:{width:`calc((100% - 52px) / ${a})`},className:"border border-slate-300 p-1.5 text-center",children:[e.jsxs("span",{className:"font-mono text-[10.5px] block text-slate-950 font-black",children:["🚪 ",u.room.num]}),e.jsxs("span",{className:"block text-[8px] text-slate-500 font-medium normal-case truncate max-w-full mx-auto mt-0.5",children:["(",u.room.sub||"sala ogólna",")"]})]},x))]})]}),e.jsx("tbody",{children:F.map((u,x)=>e.jsxs("tr",{className:"hover:bg-slate-50/40",children:[e.jsxs("td",{className:"w-[52px] min-w-[52px] max-w-[52px] border border-slate-300 p-1.5 font-mono text-center bg-slate-50/60",children:[e.jsx("span",{className:"font-black text-slate-900 text-[11px] block",children:u.num}),e.jsxs("span",{className:"block text-[7.5px] text-slate-500 leading-none mt-0.5 font-medium",children:[u.start,"-",u.end]})]}),r.map((h,g)=>{const f=Ee(h,s,u.num,x);return e.jsx("td",{style:{width:`calc((100% - 52px) / ${a})`},className:"border border-slate-300 p-1.5 align-middle text-center bg-white min-h-[44px]",children:f.length>0?e.jsx("div",{className:"space-y-1",children:f.map((j,N)=>e.jsxs("div",{className:"leading-tight flex flex-col items-center justify-center text-center py-0.5",title:`${j.displayText} (${j.subject})`,children:[e.jsx("span",{className:"font-black text-slate-950 text-[10.5px]",children:j.className}),j.groupShort&&e.jsx("span",{className:"text-indigo-700 text-[8.5px] font-bold",children:j.groupShort}),e.jsx("span",{className:"text-[9.5px] text-slate-800 font-extrabold truncate max-w-full",title:j.subject,children:j.subjectShort||j.subject}),j.teacherAbbr&&e.jsx("span",{className:"text-slate-600 text-[8.5px] font-mono font-bold",children:j.teacherAbbr})]},N))}):e.jsx("span",{className:"text-[10px] text-slate-300 font-bold font-mono",children:"-"})},g)})]},u.num))})]})})]},`${s}-${o.id}-${l}`)})})},s))})]})}if($e)return e.jsxs("div",{id:"weekly-print-overlay",className:"fixed inset-0 bg-slate-100/90 backdrop-blur-md z-[9999] overflow-y-auto p-4 md:p-8 font-sans text-slate-800",children:[e.jsx("style",{dangerouslySetInnerHTML:{__html:`
          @media print {

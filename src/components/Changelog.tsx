  ...
  const versions: Version[] = [
    ...
    },
    {
      ...
      changes: [
        ...
        { type: 'improvement', text: 'Podręczny Pasek Skrótów pod Tabelą Płachty: Pod każdą tabelą (w arkuszu tygodniowym A3/A2 oraz w arkuszach dziennych) umieszczono kompaktowy pasek szybkiego odczytu najczęstszych skrótów przedmiotów.', badgeText: 'Pasek Skrótów' },
    ...
    },
    {
      ...
      changes: [
        ...
        { type: 'security', text: 'Weryfikacja szyfrowania kopii zapasowej przed scaleniem: W oknie ImportModal.tsx zaimplementowano sprawdzanie obecności nagłówka szyfrowania (AES-256 GCM) przed próbą zaimportowania do bazy danych. W przypadku zaszyfrowanego pliku wyświetlany jest dedykowany formularz z polem typu password oraz przyciskiem "Odszyfruj". Blokowane jest scalanie i podgląd nieodszyfrowanych danych, a po poprawnym deszyfrowaniu schemat JSON jest weryfikowany przed dołączeniem do bazy.', badgeText: 'Kopie Zapasowe' }
      ]
    },
    {
      version: 'v3.8.2',
